...
class Exhibition_Entry(models.Model):
    ...
    explanation_video_link = models.CharField(max_length=100, default='/')
    #Research Paper as pdf
    research_paper = models.FileField(upload_to='uploads/Research_Paper',  default='uploads/Poster/eyrcs2023.png')
